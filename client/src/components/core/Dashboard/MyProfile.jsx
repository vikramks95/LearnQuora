...
import { formattedDate } from '../../../Util/dateFormater'
...
const MyProfile = () => {
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
        ...
        <div className="flex items-center gap-x-2">
          ...
          <div>
            ...
            <p className="text-sm font-semibold text-richblack-300">{user?.email}</p>
          </div>
        </div>
      ...
      <div className = "flex flex-col gap-y-10 my-10 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
        ...
        <p className = {`${user?.additionalDetails?.about ? "text-richblack-5" : "text-richblack-400"}`}>
           {
              user?.additionalDetails?.about ? user?.additionalDetails?.about : "Write Something About You"
           }
        </p>
